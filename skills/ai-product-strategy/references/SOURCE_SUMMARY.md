...
- **Artifact:** Workflow/role-shift notes in the Strategy Thesis (`TEMPLATES.md`).
...
- **Artifact:** Empirical Learning Plan template (`TEMPLATES.md`) + quality gate (`CHECKLISTS.md`).
...
- **Artifact:** Autonomy Policy table + risk checklist (`TEMPLATES.md`, `CHECKLISTS.md`).
...
- **Artifact:** Autonomy Policy + Eval Plan sections (`TEMPLATES.md`).
...
- **Artifact:** System Plan template (`TEMPLATES.md`) + rubric items (`RUBRIC.md`).
