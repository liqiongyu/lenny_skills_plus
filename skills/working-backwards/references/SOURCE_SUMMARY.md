...
Source: `sources/refound/raw/working-backwards/SKILL.md`

The source skill is insight-heavy and focuses on **customer obsession**, avoiding solution-first thinking, and using “working backwards” to align not just a document but the full organizational plan to ship.

The excerpt provided includes 5 guest insights (the original mentions more; the referenced deep-dive file is not present in the raw source folder).
